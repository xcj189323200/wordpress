...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'boke-2' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'boke-2' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'boke-2' ),
		'cyrillic'     => __( 'Cyrillic', 'boke-2' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'boke-2' ),
		'devanagari'   => __( 'Devanagari', 'boke-2' ),
		'greek'        => __( 'Greek', 'boke-2' ),
		'greek-ext'    => __( 'Greek Extended', 'boke-2' ),
		'khmer'        => __( 'Khmer', 'boke-2' ),
		'latin'        => __( 'Latin', 'boke-2' ),
		'latin-ext'    => __( 'Latin Extended', 'boke-2' ),
		'vietnamese'   => __( 'Vietnamese', 'boke-2' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'boke-2' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'boke-2' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'boke-2' ),
