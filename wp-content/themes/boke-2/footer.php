			...
			<div class="container">
				...
				<div class="site-info">
					...
					?>
						...
						&copy; <?php echo date("Y"); ?> <a href="<?php echo esc_url( home_url() ); ?>"><?php bloginfo('name'); ?></a> - <?php esc_html_e('主题巴巴原创', 'boke-2'); ?> <a href="<?php echo esc_url( $author_uri ); ?>" target="_blank">WordPress 主题</a>
...
<?php if( get_theme_mod('back-top-on', true) == true) : ?>
	...
	<div id="back-top">
		<a href="#top" title="<?php echo __('返回顶部', 'boke-2'); ?>"><span class="genericon genericon-collapse"></span></a>
	</div>
