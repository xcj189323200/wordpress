...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'zimeiti-2' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'zimeiti-2' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'zimeiti-2' ),
		'cyrillic'     => __( 'Cyrillic', 'zimeiti-2' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'zimeiti-2' ),
		'devanagari'   => __( 'Devanagari', 'zimeiti-2' ),
		'greek'        => __( 'Greek', 'zimeiti-2' ),
		'greek-ext'    => __( 'Greek Extended', 'zimeiti-2' ),
		'khmer'        => __( 'Khmer', 'zimeiti-2' ),
		'latin'        => __( 'Latin', 'zimeiti-2' ),
		'latin-ext'    => __( 'Latin Extended', 'zimeiti-2' ),
		'vietnamese'   => __( 'Vietnamese', 'zimeiti-2' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'zimeiti-2' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'zimeiti-2' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'zimeiti-2' ),
