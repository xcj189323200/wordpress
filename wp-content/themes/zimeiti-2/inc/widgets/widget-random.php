 ...
 * @since      1.0.0
 */
class zimeiti_2_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-zimeiti_2-random widget_posts_thumbnail',
			'description' => __( '显示随机的文章（带缩略图）', 'zimeiti-2' )
		);

		// Create the widget.
		parent::__construct(
			'zimeiti_2-random',                                   // $this->id_base
			__( '&raquo; 随机文章', 'zimeiti-2' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( '随机文章', 'zimeiti-2' ),
			'limit'     => 5,
			'show_date' => true
		);
