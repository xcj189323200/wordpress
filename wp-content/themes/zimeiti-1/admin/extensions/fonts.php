...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'zimeiti-1' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'zimeiti-1' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'zimeiti-1' ),
		'cyrillic'     => __( 'Cyrillic', 'zimeiti-1' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'zimeiti-1' ),
		'devanagari'   => __( 'Devanagari', 'zimeiti-1' ),
		'greek'        => __( 'Greek', 'zimeiti-1' ),
		'greek-ext'    => __( 'Greek Extended', 'zimeiti-1' ),
		'khmer'        => __( 'Khmer', 'zimeiti-1' ),
		'latin'        => __( 'Latin', 'zimeiti-1' ),
		'latin-ext'    => __( 'Latin Extended', 'zimeiti-1' ),
		'vietnamese'   => __( 'Vietnamese', 'zimeiti-1' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'zimeiti-1' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'zimeiti-1' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'zimeiti-1' ),
