 ...
 * @since      1.0.0
 */
class zimeiti_1_Ad_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( '插入广告代码即可展示相应广告', 'zimeiti-1' ),
		...
		parent::__construct(
			...
			esc_html__( '&raquo; 广告', 'zimeiti-1' ), // $this->name
