 ...
 * @since      1.0.0
 */
class zimeiti_1_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-zimeiti_1-views widget_posts_thumbnail',
			'description' => __( '显示浏览次数最多的文章（带缩略图）', 'zimeiti-1' )
		);

		// Create the widget.
		parent::__construct(
			'zimeiti_1-views',                                        // $this->id_base
			__( '&raquo; 浏览最多的文章', 'zimeiti-1' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( '浏览最多的文章', 'zimeiti-1' ),
			'limit'     => 5,
			'show_date' => true
		);
