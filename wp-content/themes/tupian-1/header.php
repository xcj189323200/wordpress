...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header <?php if(get_theme_mod('header-style', 'choice-2') == 'choice-2') { echo 'header-alt'; } ?> clear">
		...
		<div class="site-start clear">
			...
			<?php if (get_theme_mod('header-style', 'choice-2') == 'choice-1') { ?>
			...
			<?php if(get_theme_mod('header-style', 'choice-2') == 'choice-2') : ?>

			<?php if ( get_theme_mod('header-search-on', true) ) : ?>

				<div class="header-search-alt">
					<form id="searchform-alt" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>">
