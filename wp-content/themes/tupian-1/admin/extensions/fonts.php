...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'tupian-1' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'tupian-1' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'tupian-1' ),
		'cyrillic'     => __( 'Cyrillic', 'tupian-1' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'tupian-1' ),
		'devanagari'   => __( 'Devanagari', 'tupian-1' ),
		'greek'        => __( 'Greek', 'tupian-1' ),
		'greek-ext'    => __( 'Greek Extended', 'tupian-1' ),
		'khmer'        => __( 'Khmer', 'tupian-1' ),
		'latin'        => __( 'Latin', 'tupian-1' ),
		'latin-ext'    => __( 'Latin Extended', 'tupian-1' ),
		'vietnamese'   => __( 'Vietnamese', 'tupian-1' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'tupian-1' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'tupian-1' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'tupian-1' ),
