 ...
 * @since      1.0.0
 */
class tupian_1_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-tupian_1-random widget_posts_thumbnail',
			'description' => __( '显示随机的文章（带缩略图）', 'boke-2' )
		);

		// Create the widget.
		parent::__construct(
			'tupian_1-random',                                   // $this->id_base
			__( '&raquo; 随机文章', 'boke-2' ), // $this->name
