...
require_once get_stylesheet_directory() . '/inc/plugins/wp-clean-up/wp-clean-up.php';

function cao_admin_page() {
    require_once get_stylesheet_directory() . '/inc/admin/page/index.php';
}

function cao_order_page() {
    require_once get_stylesheet_directory() . '/inc/admin/page/order.php';
}

function cao_paylog_page() {
    require_once get_stylesheet_directory() . '/inc/admin/page/paylog.php';
}

function cao_vip_page() {
    // require_once get_stylesheet_directory() . '/inc/admin/page/vip.php';
}

function cao_cdk_page() {
    require_once get_stylesheet_directory() . '/inc/admin/page/cdk.php';
}

function cao_ref_page() {
    require_once get_stylesheet_directory() . '/inc/admin/page/ref.php';
}

function cao_charge_page() {
    require_once get_stylesheet_directory() . '/inc/admin/page/charge.php';
}
function cao_balance_page() {
    require_once get_stylesheet_directory() . '/inc/admin/page/balance.php';
}