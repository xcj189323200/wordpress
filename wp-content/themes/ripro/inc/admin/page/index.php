...
// 总订单 
$order_total_count = $wpdb->get_var("SELECT COUNT(id) FROM $order_table_name WHERE order_type ='charge'");
$order_total_sum = $wpdb->get_var("SELECT SUM(order_price) FROM $order_table_name WHERE order_type ='charge'");
$order_total_sum_ok = $wpdb->get_var("SELECT SUM(order_price) FROM $order_table_name WHERE order_type ='charge' AND status =1");

// 本月
$order_month_count = $wpdb->get_var("SELECT COUNT(id) FROM $order_table_name WHERE order_type ='charge' AND create_time > $beginThismonth AND create_time < $endThismonth");
$order_month_sum = $wpdb->get_var("SELECT SUM(order_price) FROM $order_table_name WHERE order_type ='charge' AND create_time > $beginThismonth AND create_time < $endThismonth");
$order_month_sum_ok = $wpdb->get_var("SELECT SUM(order_price) FROM $order_table_name WHERE order_type ='charge' AND status =1 AND create_time > $beginThismonth AND create_time < $endThismonth");

// 今天

$order_today_count = $wpdb->get_var("SELECT COUNT(id) FROM $order_table_name WHERE order_type ='charge' AND create_time > $beginToday AND create_time < $endToday");
$order_today_count = ($order_today_count) ? $order_today_count : 0 ;

$order_today_sum = $wpdb->get_var("SELECT SUM(order_price) FROM $order_table_name WHERE order_type ='charge' AND create_time > $beginToday AND create_time < $endToday");
$order_today_sum = ($order_today_sum) ? $order_today_sum : '0.00' ;
$order_today_sum_ok = $wpdb->get_var("SELECT SUM(order_price) FROM $order_table_name WHERE order_type ='charge' AND status =1 AND create_time > $beginToday AND create_time < $endToday");
		        ...
		        <div class="layui-card-body" style=" background-color: #dadada; ">
					<div class="layui-row layui-col-space15">
						<div class="layui-col-sm6 layui-col-md4">
					      <div class="layui-card">
					        <div class="layui-card-header">总订单<span class="layuiadmin-badge"><?php echo sprintf('%0.2f', $order_total_count); ?> 条</span></div>
					        <div class="layui-card-body layuiadmin-card-list">
					          <p class="layuiadmin-big-font">￥ <?php echo $order_total_sum ?></p>
					          <p>实际支付 <span class="layuiadmin-span-color">￥ <?php echo sprintf('%0.2f', $order_total_sum_ok); ?></span></p>
					        </div>
					      </div>
					    </div>
					    ...
					    <div class="layui-col-sm6 layui-col-md4">
					      <div class="layui-card">
					        ...
					        <div class="layui-card-body layuiadmin-card-list">
					          <p class="layuiadmin-big-font">￥ <?php echo sprintf('%0.2f', $order_month_sum); ?></p>
					          <p>实际支付 <span class="layuiadmin-span-color">￥ <?php echo sprintf('%0.2f', $order_month_sum_ok); ?></span></p>
					        </div>
					      </div>
					    </div>
					    ...
					    <div class="layui-col-sm6 layui-col-md4">
					      <div class="layui-card">
					        ...
					        <div class="layui-card-body layuiadmin-card-list">
					          <p class="layuiadmin-big-font">￥ <?php echo sprintf('%0.2f', $order_today_sum); ?></p>
					          <p>实际支付 <span class="layuiadmin-span-color">￥ <?php echo sprintf('%0.2f', $order_today_sum_ok); ?></span></p>
					        </div>
					      </div>
					    </div>
		        ...
		        <div class="layui-card-body">
					...
					?>
			            <dd>
			                ...
			                <div>
			                  <p>用户：<?php echo $userss->user_login ?>  <?php echo $item->note?></p>
