                                                ...
                                                <tr style=" background-color: #f5f5f5; ">
                                                    ...
                                                    <td>
                                                        <?php
                                                            ...
                                                            $qr_weixin_img = ($qr_weixin) ? $qr_weixin : get_stylesheet_directory_uri() . '/assets/images/icons/qr.jpg' ;

                                                            $qr_alipay_img = ($qr_alipay) ? $qr_alipay : get_stylesheet_directory_uri() . '/assets/images/icons/qr.jpg' ;
                                                        ?>
