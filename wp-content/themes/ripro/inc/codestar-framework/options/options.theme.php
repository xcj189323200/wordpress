        ...
        array(
            ...
            'fields' => array(
                array(
                    ...
                    'library'     => 'image',
                    'placeholder' => 'http://',
                    'default'     => get_stylesheet_directory_uri() . '/assets/images/background/bg-2.png',
                ),
                array(
                    'id'         => 'posts_1',
                    'type'       => 'text',
        ...
        array(
            ...
            'fields' => array(
                array(
                    ...
                    'library'     => 'image',
                    'placeholder' => 'http://',
                    'default'     => get_stylesheet_directory_uri() . '/assets/images/background/subscribe-bg.png',
                ),
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        array(
            ...
            'default'    => get_stylesheet_directory_uri() . '/assets/images/hero/hero.jpg',
		),
        array(
            'id'      => 'is_fancybox_img',
            'type'    => 'switcher',
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'label'   => '码支付配置，个人免签约支付，需要挂机监听，使用吗支付建议不要和其他支付混合开启，单独使用，不建议和其他支付混合使用',
            'default' => false,
        ),
        ...
        array(
            ...
            'fields'     => array(
                array(
                    'type'    => 'notice',
                    'style'   => 'success',
                    'content' => '码支付免签约官网：https://codepay.fateqq.com<br/>请在码支付后台云端设置设置通知地址为：' . get_stylesheet_directory_uri() . '/shop/codepay/notify.php',
                ),
                array(
                  'id'          => 'pay_mode',
                  'type'        => 'select',
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'       => 'text',
            'default'    => '100',
            'desc'       => '永久'._cao('site_vip_name') . '用户每日可下载次数限制，限制（会员折扣为0）的商品，正常购买的商品，不管打折还是原价，不计数',
...
CSF::createSection($prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'default'    => '<a href="https://vip.ylit.cc/" target="_blank" rel="nofollow"><img src="' . get_stylesheet_directory_uri() . '/assets/images/hero/ads.jpg"></a>',
    ...
    'fields'      => array(
        array(
            'id'      => 'disabled_wp_cdn',
             'type'    => 'switcher',
             'title'   => '启用CDN加速兼容模式',
             'desc'    => '如果您使用了CDN或者OSS插件加速，在此设置CDN域名可完美解决头像 海报等图片无法显示问题',
             'default' => true,
         ),
         array(
             'id'      => '_wp_cdn_domain',
             'type'    => 'text',
             'title'   => 'CDN域名',
             'desc'    => '例：（https://cdn.domain.com）注意http和https要加',
             'default' => '',
