			...
			<?php if ( _cao( 'cao_copyright_text', '' ) != '' ) : ?>
			  <div class="site-info">
			   <?php echo _cao( 'cao_copyright_text', '' ); ?><
				...
				<a href="/wp-admin/" target="_blank" class="text">www.langvs.xyz<br></a> 
			    <?php endif; ?>
			  </div>
			<?php endif; ?>
		</div>
...
<div class="rollbar">
	<div class="rollbar-item" etap="to_full"><i class="fa fa-arrows-alt"></i></div>
	<?php if (_cao('is_ripro_dark_btn')) : ?>
    <div class="rollbar-item tap-dark" etap="tap-dark"><i class="mdi mdi-brightness-4"></i></div>
    <?php endif; ?>
