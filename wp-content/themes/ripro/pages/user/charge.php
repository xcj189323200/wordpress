                        ...
                        <div class="input-group">
                            ...
                            <span class="flex-center payradio">
                                  ...
                                  <label class="" for="pay_ali">
                                    <img src="<?php echo get_stylesheet_directory_uri() . '/assets/icons/alipay.png';?>" height="35" class="mr-2">
                                  </label>
                            </span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div style=" margin-right: 20px; ">
                                <span class="flex-center payradio">
                                      ...
                                      <label class="" for="pay_weixin">
                                        <img src="<?php echo get_stylesheet_directory_uri() . '/assets/icons/weixin.png';?>" height="35" class="mr-2">
                                      </label>
                                </span>
                            </div>
                            <?php endif; ?>
                            ...
                            <div style=" margin-right: 20px; ">
                                <span class="flex-center payradio">
                                      ...
                                      <label class="" for="kami">
                                        <img src="<?php echo get_stylesheet_directory_uri() . '/assets/icons/kami.png';?>" height="35" class="mr-2">
                                      </label>
                                </span>
                            </div>
                            <?php endif; ?>
