 ...
 * @since      1.0.0
 */
class menhu_1_Random_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-menhu-1-random widget_posts_thumbnail',
			'description' => __( '显示随机的文章', 'menhu-1' )
		);

		// Create the widget.
		parent::__construct(
			'menhu_1-random',                                   // $this->id_base
			__( '&raquo; 随机文章', 'menhu-1' ), // $this->name
