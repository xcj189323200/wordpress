 ...
 * @since      1.0.0
 */
class menhu_1_Ad_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( '插入广告代码即可展示广告', 'menhu-1' ),
			'customize_selective_refresh' => true
		);

		// Create the widget.
		parent::__construct(
			'zhutibaba-ad',                                    // $this->id_base
			esc_html__( '&raquo; 广告', 'menhu-1' ), // $this->name
