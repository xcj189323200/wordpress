 ...
 * @since      1.0.0
 */
class menhu_1_Block_One_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-menhu-1-home-block-one',
		...
		parent::__construct(
			...
			__( '&raquo; 首页内容 - 1个栏目', 'menhu-1' ), // $this->name
 ...
 * @since 1.0.0
 */
function menhu_1_home_one_column_meta() {
