...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'menhu-1' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'menhu-1' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'menhu-1' ),
		'cyrillic'     => __( 'Cyrillic', 'menhu-1' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'menhu-1' ),
		'devanagari'   => __( 'Devanagari', 'menhu-1' ),
		'greek'        => __( 'Greek', 'menhu-1' ),
		'greek-ext'    => __( 'Greek Extended', 'menhu-1' ),
		'khmer'        => __( 'Khmer', 'menhu-1' ),
		'latin'        => __( 'Latin', 'menhu-1' ),
		'latin-ext'    => __( 'Latin Extended', 'menhu-1' ),
		'vietnamese'   => __( 'Vietnamese', 'menhu-1' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'menhu-1' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'menhu-1' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'menhu-1' ),
