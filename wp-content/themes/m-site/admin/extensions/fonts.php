...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'm-site' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'm-site' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'm-site' ),
		'cyrillic'     => __( 'Cyrillic', 'm-site' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'm-site' ),
		'devanagari'   => __( 'Devanagari', 'm-site' ),
		'greek'        => __( 'Greek', 'm-site' ),
		'greek-ext'    => __( 'Greek Extended', 'm-site' ),
		'khmer'        => __( 'Khmer', 'm-site' ),
		'latin'        => __( 'Latin', 'm-site' ),
		'latin-ext'    => __( 'Latin Extended', 'm-site' ),
		'vietnamese'   => __( 'Vietnamese', 'm-site' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'm-site' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'm-site' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'm-site' ),
