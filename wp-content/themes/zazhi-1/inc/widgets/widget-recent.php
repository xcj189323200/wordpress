 ...
 * @since      1.0.0
 */
class zazhi_1_Recent_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-zazhi-1-recent widget_posts_thumbnail',
			'description' => __( '显示最新的文章', 'zazhi-1' )
		);

		// Create the widget.
		parent::__construct(
			'zazhi_1-recent',                                   // $this->id_base
			__( '&raquo; 最新的文章', 'zazhi-1' ), // $this->name
	...
	function flush_widget_transient() {
		delete_transient( 'zazhi_1_recent_widget_' . $this->id );
	}
