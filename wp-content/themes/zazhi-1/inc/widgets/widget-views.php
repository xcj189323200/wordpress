 ...
 * @since      1.0.0
 */
class zazhi_1_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-zazhi-1-views widget_posts_thumbnail',
			'description' => __( '显示浏览次数最多的文章', 'zazhi-1' )
		);

		// Create the widget.
		parent::__construct(
			'zazhi_1-views',                                        // $this->id_base
			__( '&raquo; 浏览最多的文章', 'zazhi-1' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( '浏览最多的文章', 'zazhi-1' ),
			'limit'     => 5,
			'show_date' => true
		);
