 ...
 * @since      1.0.0
 */
class zazhi_1_Block_One_B_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-zazhi-1-home-block-one-b',
		...
		parent::__construct(
			...
			__( '&raquo; 首页内容 - 1个栏目（B）', 'zazhi-1' ), // $this->name
		...
		echo $before_widget;
			...
			if ( $wp_query->have_posts() ) : ?>
				...
				<div class="content-block content-block-1-b clear">
					...
					<?php require trailingslashit( get_template_directory() ) . 'template-parts/block-one-b-content.php';?>
 ...
 * @since 1.0.0
 */
function zazhi_1_home_one_b_column_meta() {
