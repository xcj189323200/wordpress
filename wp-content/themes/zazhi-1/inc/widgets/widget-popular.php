 ...
 * @since      1.0.0
 */
class zazhi_1_Popular_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-zazhi-1-popular widget_posts_thumbnail',
			'description' => __( '显示评论最多的文章', 'zazhi-1' )
		);

		// Create the widget.
		parent::__construct(
			'zazhi_1-popular',                                   // $this->id_base
			__( '&raquo; 评论最多的文章', 'zazhi-1' ), // $this->name
	...
	function flush_widget_transient() {
		delete_transient( 'zazhi_1_popular_widget_' . $this->id );
	}
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( '评论最多的文章', 'zazhi-1' ),
			'limit'     => 5,
			'show_views' => true
		);
