...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'zazhi-1' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'zazhi-1' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'zazhi-1' ),
		'cyrillic'     => __( 'Cyrillic', 'zazhi-1' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'zazhi-1' ),
		'devanagari'   => __( 'Devanagari', 'zazhi-1' ),
		'greek'        => __( 'Greek', 'zazhi-1' ),
		'greek-ext'    => __( 'Greek Extended', 'zazhi-1' ),
		'khmer'        => __( 'Khmer', 'zazhi-1' ),
		'latin'        => __( 'Latin', 'zazhi-1' ),
		'latin-ext'    => __( 'Latin Extended', 'zazhi-1' ),
		'vietnamese'   => __( 'Vietnamese', 'zazhi-1' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'zazhi-1' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'zazhi-1' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'zazhi-1' ),
