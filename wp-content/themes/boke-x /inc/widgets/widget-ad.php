 ...
 * @since      1.0.0
 */
class boke_x_Ad_Widget extends WP_Widget {
	...
	public function __construct() {
		...
		$widget_options = array(
			...
			'description' => esc_html__( '插入广告代码即可展示相应广告', 'boke-x' ),
		...
		parent::__construct(
			...
			esc_html__( '&raquo; 广告', 'boke-x' ), // $this->name
