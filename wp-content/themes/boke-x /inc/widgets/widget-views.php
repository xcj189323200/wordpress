 ...
 * @since      1.0.0
 */
class boke_x_Views_Widget extends WP_Widget {
	...
	function __construct() {
		...
		$widget_options = array(
			'classname'   => 'widget-boke-x-views widget_posts_thumbnail',
			'description' => __( '显示浏览次数最多的文章', 'boke-x' )
		);

		// Create the widget.
		parent::__construct(
			'boke_x-views',                                        // $this->id_base
			__( '&raquo; 浏览最多的文章', 'boke-x' ), // $this->name
	...
	function form( $instance ) {
		...
		// Default value.
		$defaults = array(
			'title'     => esc_html__( '浏览最多的文章', 'boke-x' ),
			'limit'     => 6
		);
