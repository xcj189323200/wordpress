...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'boke-x' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'boke-x' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'boke-x' ),
		'cyrillic'     => __( 'Cyrillic', 'boke-x' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'boke-x' ),
		'devanagari'   => __( 'Devanagari', 'boke-x' ),
		'greek'        => __( 'Greek', 'boke-x' ),
		'greek-ext'    => __( 'Greek Extended', 'boke-x' ),
		'khmer'        => __( 'Khmer', 'boke-x' ),
		'latin'        => __( 'Latin', 'boke-x' ),
		'latin-ext'    => __( 'Latin Extended', 'boke-x' ),
		'vietnamese'   => __( 'Vietnamese', 'boke-x' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'boke-x' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'boke-x' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'boke-x' ),
